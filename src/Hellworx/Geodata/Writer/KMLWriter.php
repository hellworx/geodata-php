...
class KMLWriter
{
    ...
    protected function writeMetadata(\Hellworx\Geodata\Model\GeoMetadata $metadata, XMLWriter $xml): void
    {
    ...
    protected function writePolygon($polygonData, XMLWriter $xml): void
    {
        ...
        if (is_object($polygonData) && get_class($polygonData) === 'Hellworx\Geodata\Model\GeoPolygon') {
