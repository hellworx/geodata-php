...
class GeoDataWriterTest extends TestCase
{
    ...
    {
        $kmlWriter = new \HWX\Geodata\Writer\KMLWriter();
    ...
    {
        $geoJsonWriter = new \HWX\Geodata\Writer\GeoJSONWriter();
    ...
    public function testKmzWriter()
    {
        ...
        try {
            $kmzWriter = new \HWX\Geodata\Writer\KMZWriter();
